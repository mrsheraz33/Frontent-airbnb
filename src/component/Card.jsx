...
let {handelViewCard} = useContext(listingData)
...
const handelClick = ()=>{ 
  ...
  return (
    <div className='w-[300px] relative max-w-[85%] h-[460px] flex items-start justify-start flex-col rounded-lg cursor-pointer z-[10]
    ' onClick={()=> !isBooked ? handelClick(): null}>
 
     {isBooked &&  <div className='text-[green] bg-white rounded-lg absolute flex items-center justify-center right-1 top-1
      gap-[5px] p-[5px] '> 
     <GiConfirmed  className='w-[20px] h-[20px] text-[green]'/> Booked
      </div>}

{isBooked && host == userData?._id &&  <div className='text-[red] bg-white rounded-lg absolute flex items-center justify-center right-1 top-12
      gap-[5px] p-[5px] ' onClick={()=> setPopUp(true)}>
...
<div className='w-[100%] h-[50%] text-[#2e2d2d] flex items-start justify-center rounded-lg overflow-hidden
